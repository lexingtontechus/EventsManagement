...
export default function Myaccount() {
        ...
        .then((snapshot) => {
          snapshot.forEach((doc) => {
            if (doc.data().partner_contact_email === user.email) {
              console.log(
                "Parnter email is matched: ",
                doc.data().partner_contact_email
              );
              setAccount(
              ...
              console.log(
                "Client email is matched: ",
                doc.data().client_contact_email
              );
              setAccount(
                collection.charAt(0).toUpperCase() + collection.slice(1)
              );
  ...
  useEffect(() => {
    const fireBaseTime = new Date(
      partnerData.data_created_sec * 1000 +
        partnerData.data_created_nano / 1000000
    );
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <button onClick={() => alert(firebase.auth().currentUser.email)}>
        Show Email
      </button>
      ...
      {userRole === "partner" && (
        <div key={partnerData.id}>
          ...
          <ul style={{ listStyleType: "none", textAlign: "left" }}>
            ...
            <li>
              <b>Partner Contact Name : </b>
              {partnerData.contact_name}
            </li>
            <li>
              <b>Partner Contact Email : </b>
              {partnerData.contact_email}
            </li>
            <li>
              <b>Partner Contact Title : </b>
            ...
            <li>
              <b>Venture Funding : </b>
              {partnerData.venture_funding}
            </li>
            <li>
              <b>Data Founded : </b>
              {partnerData.date_founded}
            </li>
            <li>
              <b>Data Created : </b>
              {dateString}
            ...
            <li>
              <b>Data Updated : </b>
              {partnerData.data_updated}
            </li>
          </ul>
          {account && <h2>{account} Details</h2>}
          <ul style={{ listStyleType: "none", textAlign: "left" }}>
            <li>
              <b>Average Project Size : </b>
              {partnerglobalData.average_size}
            </li>
            <li>
              <b>Certified : </b>
              {partnerglobalData.certified}
            </li>
            <li>
              <b>Client Focus : </b>
              {partnerglobalData.client_focus}
            </li>
            <li>
              <b>Data Readiness : </b>
              {partnerglobalData.data_readiness}
            </li>
            <li>
              <b>Global Locations : </b>
              {partnerglobalData.locations}
            </li>
            <li>
              <b>Master Services Agreement : </b>
              {partnerglobalData.master_services}
            </li>
            <li>
              <b>Non-Disclousure Agreement : </b>
              {partnerglobalData.nondisclosure}
            </li>
            <li>
              <b>Pricing Model : </b>
              {partnerglobalData.price}
            </li>
            <li>
              <b>Rating : </b>
              {partnerglobalData.rating}
            </li>
            <li>
              <b>Resources Available : </b>
              {partnerglobalData.resources}
            </li>
            <li>
              <b>Reviews Description : </b>
              {partnerglobalData.reviews_desc}
            </li>
            <li>
              <b>Service Technology : </b>
              {partnerglobalData.service_tech}
            </li>
            <li>
              <b>Testimonial Description : </b>
              {partnerglobalData.testimonial_desc}
            </li>
          </ul>
      ...
      {userRole === "client" && (
        <div key={clientData.id}>
          ...
          <ul style={{ listStyleType: "none", textAlign: "left" }}>
            ...
            <li>
              <b>Client Contact Title : </b>
              {clientData.contact_title}
            </li>
            <li>
            ...
            <li>
              <b>Date Founded : </b>
              {clientData.date_founded}
            </li>
            <li>
              <b>Data Created : </b>
              {clientData.data_created}
            </li>
            <li>
              <b>Data Updated : </b>
              {clientData.data_updated}
            </li>
          </ul>
          {account && <h2>{account} Details</h2>}
          <ul style={{ listStyleType: "none", textAlign: "left" }}>
            <li>
              <b>Certified : </b>
              {clientGlobalData.certified}
            </li>
            <li>
              <b>Client Focus : </b>
              {clientGlobalData.client_focus}
            </li>
            <li>
              <b>Industry Focus : </b>
              {clientGlobalData.industry_focus}
            </li>
          </ul>
          {account && <h2>{account} Use Case Information</h2>}
          <ul style={{ listStyleType: "none", textAlign: "left" }}>
            ...
            <li>
              <b>Service Technologies : </b>
              {clientUsecase.service_tech}
            </li>
            <li>
              <b>Measure of Success : </b>
              {clientUsecase.kpi}
            </li>
            <li>
              <b>Ethical and Legal Issue : </b>
              {clientUsecase.issue}
            </li>
            <li>
              <b>AI Tools : </b>
              {clientUsecase.ai_tools}
            </li>
            <li>
              <b>Cloud Infrastructure : </b>
              {clientUsecase.cloud_inf}
            </li>
            <li>
              <b>Use Case Description : </b>
              {clientUsecase.desc}
